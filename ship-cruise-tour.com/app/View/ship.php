...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item lii">
    <a class="nav-link active" href="ship">ship</a>
  </li>
  <li class="nav-item lii">
...
<div>
    <a href="addShip" class="btn btn-outline-primary m-2 mb-3">ADD SHIP</a>
</div>
...
?>
<tr><td>      
        <a href="sd?id=<?php echo $row['id'] ?>" class="link-primary"><i class="fa-solid fa-trash fs-6 me-3"></i></a>
      </td>
      
      <td><?php echo $row['id'] ?></td>
      <td><?php echo $row['name'] ?></td>
      <td><?php echo $row['num-of-rooms'] ?></td>
      <td><?php echo $row['num-of-places'] ?></td>
