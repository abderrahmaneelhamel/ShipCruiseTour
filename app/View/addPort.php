...
<body style="background-color:white ;">
    <div class="container">
        <div class="text-center mb-4">
            <h3 class="log2" style="color:rgb(10 82 189);">ADD NEW PORT</h3>
        </div>
        ...
        <form method="post" style="width:50vw; min-width:300px ;" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="row">
                        <label class="log" style="color:rgb(10 82 189);">country</label>
                ...
                <div class="col ret">
                    <div class="sub">
                        ...
                        <a href="port" class="btn btn-outline-dark mb-4">Cancel</a>
                    </div>
                </div>    
            </form>
        </div>
